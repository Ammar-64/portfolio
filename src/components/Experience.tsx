...
const experiences = [
  {
    ...
    highlights: [
      'American VoxPop: architected the platform with 490+ API endpoints, 101 tables, and 8 government data sources across all 3 branches',
  ...
  },
  {
    ...
    description: 'Direct employment Nov 2019 to Mar 2023; continued via Alsaab Ltd through early 2025. Led digital transformation while training the next generation of engineers.',
    highlights: [
